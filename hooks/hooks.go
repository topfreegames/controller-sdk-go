...
func CreateBuild(c *deis.Client, username, app, image, gitSha string, procfile api.ProcessType, sidecarfile api.ProcessSidecar, usingDockerfile bool) (int, error) {
