...
type Build struct {
	...
	Sidecarfile map[string]interface{} `json:"sidecarfile"`
...
type CreateBuildRequest struct {
	...
	Sidecarfile map[string]interface{} `json:"sidecarfile,omitempty"`
}
...
type BuildHookRequest struct {
	...
	Sidecarfile ProcessSidecar `json:"sidecarfile"`
}
